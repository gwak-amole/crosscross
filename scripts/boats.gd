...
signal contacted(boat: CharacterBody2D)

@export var dir: Vector2 = Vector2.DOWN
@export var profile: BoatsProfile

@onready var anim: AnimatedSprite2D = $AnimatedSprite2D
@onready var hitbox: Area2D = $boat_hitbox
...
func _ready() -> void:
	...
	var cb := Callable(self, "_on_boat_hitbox_area_entered")
